...
var InfoCard = function (_React$Component) {
  ...
  (0, _createClass3.default)(InfoCard, [{
    ...
    value: function render() {
      return _react2.default.createElement('div', { className: this.getRootClassName(), 'data-jsx': 2844247013
        ...
        styleId: 2844247013,
        css: 'div.root[data-jsx="2844247013"]{-webkit-flex:1;-ms-flex:1;flex:1;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;padding:0;margin:0;background-color:' + _colors.themeColors.medMuted + ';color:' + _colors.themeColors.medLight + ';margin:5px;border-radius:17.5px;padding:7.5px 12.5px;min-width:150px}div.tinted[data-jsx="2844247013"]{background-color:' + _colors.themeColors.med + ';color:' + _colors.themeColors.light + '}p[data-jsx="2844247013"]{margin:0;font-size:16px;font-weight:500}h1[data-jsx="2844247013"]{margin:0 0 15px 0;font-weight:700;font-size:35px;-webkit-align-self:center;-ms-flex-item-align:center;align-self:center}'
      }));
    }
  }]);
